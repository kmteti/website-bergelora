...
export interface Config {
  ...
  collectionsSelect: {
    ...
    bso: BsoSelect<false> | BsoSelect<true>;
    events: EventsSelect<false> | EventsSelect<true>;
    layanan: LayananSelect<false> | LayananSelect<true>;
    faq: FaqSelect<false> | FaqSelect<true>;
    narahubung: NarahubungSelect<false> | NarahubungSelect<true>;
...
export interface News {
  ...
  slug: string;
  category: 'Press Release' | 'TETI Champion';
  /**
   * Tanggal berita dipublikasikan
   */
  date: string;
  image: number | Media;
  content: {
...
export interface Divisi {
  ...
  slug: string;
  /**
   * Contoh: Advokasi dan Kesejahteraan Mahasiswa
   */
  detail: string;
  /**
   * Contoh: /logo/divisi/adkesma.svg
   */
  logo: string;
  /**
  ...
  header: string;
  /**
   * Contoh: Kesejahteraan Mahasiswa adalah Tanggung Jawab Kami
   */
  tujuan: string;
...
export interface Bso {
  ...
  slug: string;
  /**
   * Contoh: Mahasiswa Ketenagalistrikan
   */
  detail: string;
  /**
   * Contoh: /logo/bso/magatrika.svg
   */
  logo: string;
  /**
  ...
  header: string;
  /**
   * Contoh: Inovasi di Bidang Energi
   */
  tujuan: string;
  deskripsi_tujuan: string;
  proker?:
...
export interface Event {
  id: number;
  /**
   * Contoh: FindIT! / NESCO UGM / Technocorner
   */
  nama: string;
  /**
   * When enabled, the slug will auto-generate from the title field on save and autosave.
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "layanan".
 */
export interface Layanan {
  id: number;
  /**
   * Contoh: Akademik DTETI / Manual Book Kesekretariatan
   */
  title: string;
  description: string;
  /**
   * Contoh: https://sarjana.jteti.ugm.ac.id/ atau link drive/form
   */
  href: string;
  kategori: 'Link Penting' | 'Arsip Divisi' | 'Dokumen dan SOP' | 'Sekretaris dan Bendahara' | 'Lainnya';
  icon?:
    | (
        | 'AArrowDown'
        | 'AArrowDownIcon'
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "narahubung".
 */
export interface Narahubung {
  id: number;
  /**
   * Contoh: Nawa / Ali / Budi
   */
  nama: string;
  /**
   * Contoh: Humas KMTETI / CP Sponsorship
   */
  keterangan?: string | null;
  /**
   * Format tanpa tanda + atau spasi, contoh: 6283865340087
   */
  whatsapp: string;
  order?: number | null;
  updatedAt: string;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'narahubung';
        value: number | Narahubung;
      } | null);
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "bso_select".
 */
export interface BsoSelect<T extends boolean = true> {
  nama?: T;
  generateSlug?: T;
  slug?: T;
  detail?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "layanan_select".
 */
export interface LayananSelect<T extends boolean = true> {
  title?: T;
  description?: T;
  href?: T;
  kategori?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "narahubung_select".
 */
export interface NarahubungSelect<T extends boolean = true> {
  nama?: T;
  keterangan?: T;
  whatsapp?: T;
  order?: T;
