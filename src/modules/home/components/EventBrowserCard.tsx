...
export default function EventBrowserCard({
  ...
  return (
    <article
      className={cn(
        'relative h-[60.03cqw] min-h-[260px] w-full overflow-hidden rounded-[4.14cqw] bg-white shadow-[0_20px_30px_rgba(0,0,0,0.2)]',
        className,
      )}
    >
      {/* Title bar */}
      ...
      {/* Pita biru di belakang logo */}
      <div className="h-[13.2cqw] w-full bg-gradient-to-b from-[#334bb5] to-[#1e308e]" />

      {/* Konten — sengaja absolute supaya logo-nya menimpa pita biru persis kayak Figma */}
