...
const buttonVariants = cva(
  'btn relative inline-flex cursor-pointer items-center justify-center border-0 font-medium tracking-normal whitespace-nowrap outline-none select-none disabled:pointer-events-none disabled:opacity-55 disabled:grayscale-[0.25] focus-visible:outline-3 focus-visible:outline-offset-4',
  {
    variants: {
      ...
      size: {
        sm: 'h-10 rounded-full px-3.5 py-0 text-sm leading-5 gap-1.5 [--btn-icon-size:14px]',
        default: 'h-11 rounded-full px-4 py-0 text-base leading-6 gap-2 [--btn-icon-size:16px]',
        lg: 'h-[52px] rounded-full px-5 py-0 text-base leading-6 gap-2.5 [--btn-icon-size:18px]',
        icon: 'size-11 min-w-11 rounded-full p-0 [--btn-icon-size:18px]',
      },
    },
    defaultVariants: {
      variant: 'primary',
